...
/*
% go run httpd_complete.go 

//On different termnla, try following curl commands :
 % curl -d@req.json http://localhost:8080/math
{"error":"division by 0","result":0}
mayurmore@PNQ-MMORE ch8 % curl -d@req2.json http://localhost:8080/math
{"error":"","result":6}
